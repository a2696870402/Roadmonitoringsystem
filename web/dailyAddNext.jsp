                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="row">
                                            <label for="main_road" readonly="readonly" class="col-xs-2 control-label">路面类型：</label>
                                            <div class="col-xs-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control input-sm duiqi" id="daily_des" name="daily_des" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="daily_note" class="col-xs-2 control-label">备注：</label>
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control input-sm duiqi" id="daily_note" name="daily_note" >
                                            </div>
                                        </div>
                                </div>
                                <div class="container-fluid">
                                ...
                                <div class="modal-footer">
                                    <input id="next_to" type="button" class="btn btn-success btn-xs" href="" onclick="getkey()" value="录入下一个">
                                    <input id="save_qw" type="submit" onclick="sublim_e()" class="btn btn-xs  btn-green" name="submit" value="保存并退出">
                                    <button type="button" href="daily.jsp" class="btn btn-xs " onclick="window.location.href='dailyServlet'">取消</button>
                                </div>
