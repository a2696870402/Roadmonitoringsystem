                                ...
                                <div class="container-fluid">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2 ">
                                                <input type="date" readonly="readonly" class="form-control input-sm duiqi" id="d_date" name="d_date" value="<%=d.getD_date()%>">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2 ">
                                                <input type="text" readonly="readonly" class="form-control input-sm duiqi" id="road_id"  name="road_id" value="<%=d.getRoad_id()%>">
                                            </div>
                                            <label for="road_name"  class="col-xs-2 control-label">道路名称*：</label>
                                            <div class="col-xs-2 ">
                                                <input type="text"  readonly="readonly" class="form-control input-sm duiqi" id="road_name" name="road_name" value="<%=d.getRoad_name()%>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2">
                                                <input type="text" readonly="readonly" class="form-control input-sm duiqi" id="main_road" name="main_road" value="<%=d.getMain_road()%>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="d_start" class="col-xs-2 control-label">起止位置：</label>
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control input-sm duiqi" id="d_start" name="d_start" >
                                            </div>
                                            <label for="d_Alllen" class="col-xs-2 control-label">检查总长（m）：</label>
                                            <div class="col-xs-2">
                                                <input type="number" min=0 class="form-control input-sm duiqi" id="d_Alllen" name="d_Alllen" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="d_Allwidth" class="col-xs-2 control-label">检查总宽（m）：</label>
                                            <div class="col-xs-2">
                                                <input type="number" min=0 class="form-control input-sm duiqi" id="d_Allwidth" name="d_Allwidth" >
                                            </div>
                                            <label for="d_len" class="col-xs-2 control-label">损坏长（m）：</label>
                                            <div class="col-xs-2">
                                                <input type="number" min=0 class="form-control input-sm duiqi" id="d_len" name="d_len" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="d_width" min=0 class="col-xs-2 control-label">损坏宽（m）：</label>
                                            <div class="col-xs-2">
                                                <input type="number" class="form-control input-sm duiqi" id="d_width" name="d_width">
                                            </div>
                                            <label for="d_height" min=0 class="col-xs-2 control-label">损坏高（m）：</label>
                                            <div class="col-xs-2">
                                                <input type="number" class="form-control input-sm duiqi" id="d_height" name="d_height" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="d_des" class="col-xs-2 control-label">损坏位置及描述：</label>
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control input-sm duiqi" id="d_des" name="d_des" >
                                            </div>
                                            <label for="d_note" class="col-xs-2 control-label">备注：</label>
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control input-sm duiqi" id="d_note" name="d_note" >
                                            </div>
                                        </div>
                                </div>
                                <div class="container-fluid">
