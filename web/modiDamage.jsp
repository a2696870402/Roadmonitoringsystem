                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <form class="form-horizontal">
                                        <% damage r=(damage)request.getSession().getAttribute("upDamage");%>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="" class="form-control input-sm duiqi" id="rMS" name="main_shape" value="<%=r.getMain_shape()%>"8>
                                        </div>
                                        <label for="rMC" class="col-xs-2 control-label">损坏大类：</label>
                                        <div class="col-xs-3">
                                            <input type="" class="form-control input-sm duiqi" id="rMC" name="main_class" value="<%=r.getMain_class()%>">
                                        </div>
                                    </div>
                            </div>
                        </div>
